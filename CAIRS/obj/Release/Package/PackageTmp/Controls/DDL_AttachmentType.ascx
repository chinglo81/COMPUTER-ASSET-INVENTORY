...
<asp:RequiredFieldValidator runat="server" ID="reqAttachmentType" ControlToValidate="ddlAttachmentType" CssClass="invalid" InitialValue="-1" Display="Dynamic" EnableClientScript="true" Text="Required"></asp:RequiredFieldValidator>
